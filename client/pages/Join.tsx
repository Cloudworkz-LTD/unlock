          ...
          <div className="flex flex-col items-center gap-8 lg:gap-12">
            ...
            <div className="text-center max-w-2xl">
              <p className="text-unlock-light font-aeonik text-lg md:text-xl font-light leading-[1.3]">
                Join our waiting list to be among the first to access Unlock's
                comprehensive due diligence services and investment insights.
              </p>
            </div>
            ...
            <div className="w-full max-w-md">
              <form className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                  <label
                    htmlFor="email"
                    className="text-unlock-light font-aeonik text-sm font-medium"
                  >
                    Email Address
                  </label>
                  <input
            ...
            <div className="text-center max-w-lg">
              <p className="text-unlock-light/80 font-aeonik text-sm font-light leading-[1.4]">
                By joining our waiting list, you'll receive updates about our
                launch and exclusive early access to our platform. We respect
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12 w-full">
              ...
              <div className="flex flex-col items-center text-center gap-6 p-6">
                ...
                <p className="text-unlock-dark/80 font-aeonik text-base font-light leading-[1.4]">
                  Be the first to access our platform when we launch, with
                  exclusive early-bird pricing and features.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center text-center gap-6 p-6">
                ...
                <p className="text-unlock-dark/80 font-aeonik text-base font-light leading-[1.4]">
                  Receive curated investment insights and market analysis
                  reports before they're available to the public.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center text-center gap-6 p-6">
                ...
                <p className="text-unlock-dark/80 font-aeonik text-base font-light leading-[1.4]">
                  Join an exclusive community of like-minded investors and gain
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="flex flex-col items-center gap-8">
            ...
            <p className="text-unlock-light/80 font-aeonik text-lg font-light leading-[1.3] max-w-2xl">
              ...
              experience next-generation due diligence services.
            </p>
            <UnlockButton
              size="default"
