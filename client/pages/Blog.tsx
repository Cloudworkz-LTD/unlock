        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-5 px-0 sm:px-4">
            ...
            <div className="flex items-center gap-4">
              <svg
                className="w-8 h-8 stroke-unlock-green"
                viewBox="0 0 32 32"
                fill="none"
              >
                <path
                  d="M23.9987 2.66602H19.9987C18.2306 2.66602 16.5349 3.36839 15.2847 4.61864C14.0344 5.86888 13.332 7.56457 13.332 9.33268V13.3327H9.33203V18.666H13.332V29.3327H18.6654V18.666H22.6654L23.9987 13.3327H18.6654V9.33268C18.6654 8.97906 18.8058 8.63992 19.0559 8.38987C19.3059 8.13982 19.6451 7.99935 19.9987 7.99935H23.9987V2.66602Z"
                  strokeLinecap="round"
              ...
              >
                <path
                  d="M21.332 10.666C23.4538 10.666 25.4886 11.5089 26.9889 13.0092C28.4892 14.5095 29.332 16.5443 29.332 18.666V27.9993H23.9987V18.666C23.9987 17.9588 23.7177 17.2805 23.2176 16.7804C22.7176 16.2803 22.0393 15.9993 21.332 15.9993C20.6248 15.9993 19.9465 16.2803 19.4464 16.7804C18.9463 17.2805 18.6654 17.9588 18.6654 18.666V27.9993H13.332V18.666C13.332 16.5443 14.1749 14.5095 15.6752 13.0092C17.1755 11.5089 19.2103 10.666 21.332 10.666Z"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
                <path
                  d="M8.0013 12H2.66797V28H8.0013V12Z"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
                <path
                  d="M5.33464 7.99935C6.80739 7.99935 8.0013 6.80544 8.0013 5.33268C8.0013 3.85992 6.80739 2.66602 5.33464 2.66602C3.86188 2.66602 2.66797 3.85992 2.66797 5.33268C2.66797 6.80544 3.86188 7.99935 5.33464 7.99935Z"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
              </svg>
