      ...
      <div className="container mx-auto max-w-4xl px-4">
        <div className="text-center py-24">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            {description ||
              `The ${title.toLowerCase()} page is coming soon. We're working hard to bring you amazing content.`}
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <UnlockButton size="lg">Get Notified</UnlockButton>
        ...
        <div className="bg-unlock-light/5 rounded-lg p-8 text-center">
          ...
          <UnlockButton variant="outline">Share Your Ideas</UnlockButton>
        </div>
      </div>
    </div>
  );
