    ...
    <div className="min-h-screen bg-unlock-dark">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-28 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col items-start gap-8 lg:w-2/3">
            ...
            <div className="flex flex-col items-start gap-2 w-full">
              <h1 className="text-6xl md:text-7xl lg:text-8xl !font-light !font-aeonik text-unlock-green !leading-[0.81] tracking-[-0.03em] w-full">
                Due Diligence
              </h1>
              <h1 className="text-6xl md:text-7xl lg:text-8xl  !font-extralight !font-aeonik text-white !leading-[0.81] tracking-[-0.03em] w-full">
                for Smarter
              </h1>
              <h1 className="text-6xl md:text-7xl lg:text-8xl !font-extralight !font-aeonik text-white !leading-[0.81] tracking-[-0.03em] w-full">
                Investments
            ...
            {/* Description */}
            <p
              className="text-lg md:text-xl text-white !font-aeonik leading-[1.2] max-w-2xl"
      ...
      <section className="w-full">
        ...
        >
          ...
          <div className="flex flex-col justify-between flex-1 self-stretch gap-8 lg:gap-0">
            {/* Main Title */}
            <h2 className="text-unlock-light font-aeonik text-2xl md:text-4xl lg:text-5xl xl:text-[60px] font-light leading-[110%] max-w-full lg:max-w-[728px]">
