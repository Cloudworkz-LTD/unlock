        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-28 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col items-start gap-8 lg:w-2/3">
            ...
            <div className="flex flex-col items-start gap-2 w-full">
              <h1 className="text-6xl md:text-7xl lg:text-8xl xl:text-[140px] font-light font-aeonik text-unlock-green tracking-[-0.03em] w-full">
                Due Diligence
              </h1>
              <h1 className="text-6xl md:text-7xl lg:text-8xl xl:text-[140px] font-extralight font-aeonik text-white tracking-[-0.03em] w-full">
                for Smarter
              </h1>
              <h1 className="text-6xl md:text-7xl lg:text-8xl xl:text-[140px] font-extralight font-aeonik text-white tracking-[-0.03em] w-full">
                Investments
            ...
            {/* Description */}
            <p className="text-lg md:text-xl text-white font-aeonik max-w-2xl" style={{ fontWeight: 250 }}>
