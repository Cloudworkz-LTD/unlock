        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h3 className="text-xl font-medium font-aeonik text-foreground mb-2">
                Primary Green
              </h3>
              <p className="text-unlock-gray-dark font-aeonik text-2xl font-light">
                #00BB77
              </p>
            </div>
            <div className="text-center">
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h3 className="text-lg font-medium font-aeonik text-foreground mb-2">
                Gray Light
              </h3>
              <p className="text-unlock-gray-dark font-aeonik text-xl font-light">
                #EBEFE1
              </p>
            </div>
            <div className="text-center">
        ...
        <section className="mb-12">
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-sm text-unlock-gray-dark font-aeonik uppercase tracking-wide mt-2">
                H1 - Aeonik Light 140px
              </p>
            </div>
            <div>
