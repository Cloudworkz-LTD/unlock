  ...
  return (
    <div className="min-h-screen bg-unlock-dark">
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(0deg, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0) 100%), url('https://api.builder.io/api/v1/image/assets/TEMP/9ec8aa91ee034596b7a7289cf1af4e9adbb76aed?width=2880')`,
        }}
      >
              ...
              testimonials={[
                {
                  ...
                  name: "Elena Morozova",
                  title: "Managing Partner at Novus Capital",
                },
                {
                  quote:
                ...
                },
                {
                  ...
                  name: "James Carter",
                  title: "Angel Investor, Fintech Sector",
                },
                {
                  quote:
                  ...
                  name: "Tariq El-Amin",
                  title: "Venture Partner at Apex Growth",
                },
                {
                  quote:
                  ...
                  title: "Co-Founder at Capital Bloom",
                },
                {
                  quote:
                  ...
                  name: "David Kwan",
                  title: "Principal at Skyline Ventures",
                  featured: true,
                },
              ]}
            />
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="max-w-7xl mx-auto px-4 sm:px-8 md:px-16 lg:px-[78px] py-24 lg:py-[200px]">
            <div className="flex flex-col lg:flex-row justify-between items-start gap-8 lg:gap-16">
              ...
              <div className="flex flex-col gap-4 max-w-[404px] flex-shrink-0">
                <p className="text-unlock-light font-aeonik text-sm leading-[1.5]">
                  Don't leave your investments to chance. Unlock offers
                  meticulous due diligence, turning complex data into clear,
                  actionable insights for your investment strategy. Join our
                  waiting list today and discover how Unlock can help you make
