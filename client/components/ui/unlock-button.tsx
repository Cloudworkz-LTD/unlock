...
const unlockButtonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap font-aeonik ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 rounded",
  {
    variants: {
      variant: {
        default:
